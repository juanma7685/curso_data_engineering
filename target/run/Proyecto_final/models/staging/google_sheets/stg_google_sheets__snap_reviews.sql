-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into ALUMNO11_PRO_SILVER_DB.ALUMNO11_staging.stg_google_sheets__snap_reviews as DBT_INTERNAL_DEST
        using ALUMNO11_PRO_SILVER_DB.ALUMNO11_staging.stg_google_sheets__snap_reviews__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
